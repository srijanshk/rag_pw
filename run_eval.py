...
def run_evaluation_test():
    ...
    # Configuration
    retriever_e5_model_name = "rag_train_hybrid_v4/best_model/question_encoder"
    generator_bart_model_name = "rag_train_hybrid_v4/best_model/generator" 
    ...
    eval_metrics, logged_samples = evaluate_custom_rag_model(
        ...
        max_logged_examples=300,
        K_DENSE_RETRIEVAL=100,
